...
public class CustomerController {
    ...
    public PageResult<Customer> selectPageByQuery(@RequestBody CustomerQuery customerQuery) {
        return customerService.selectPageByQuery(customerQuery);
    }
    ...
    @RequestMapping(value = "/batchDelete", method = RequestMethod.PATCH, name = "批量删除用户")
    @ResponseBody
    public AjaxResult batchDelete(@RequestBody List<Customer> customers) {
        try {
